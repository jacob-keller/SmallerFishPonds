    ...
    public class SmallerFishPond : FishPond
    {
        ...
        public new bool JumpFish()
        {
            ...
            _jumpingFish.Add(new JumpingFish(this,
                ...
                new Vector2(tileX.Value + Utility.Lerp(border_width + 0.2f,
                                                       (float)tilesWide.Value - border_width - 0.2f,
                                                       (float)Game1.random.NextDouble()),
                            tileY.Value + Utility.Lerp(border_width + 0.2f,
                                                       (float)tilesHigh.Value - border_width - 0.2f,
                                                       (float)Game1.random.NextDouble())) * 64f
                ));
            return true;
        }
        ...
        public override void drawInMenu(SpriteBatch b, int x, int y)
        {
            ...
            for (int yWater = tileY.Value; yWater < tileY.Value + 3; yWater++)
            {
                for (int xWater = tileX.Value; xWater < tileX.Value + 2; xWater++)
                {
                    ...
                    {
                        int flipOffset;
                        if ((xWater + yWater) % 2 != 0) {
                            flipOffset = (((!Game1.currentLocation.waterTileFlip) ? 128 : 0));
                        } else {
                            flipOffset = ((Game1.currentLocation.waterTileFlip ? 128 : 0));
                        }

                        b.Draw(Game1.mouseCursors,
                               new Vector2(x + xWater * 64 + 32,
                    ...
                    else
                    {
                        ...
                        b.Draw(Game1.mouseCursors,
                               ...
                               new Rectangle(Game1.currentLocation.waterAnimationIndex * 64,
                                             2064 + flipOffset + (topY ? ((int)Game1.currentLocation.waterPosition) : 0),
                                             64,
            ...
            b.Draw(texture.Value,
                   new Vector2(x + 64,
                               y + 44 + ((Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 2500.0 < 1250.0) ? 4 : 0)),
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            b.Draw(texture.Value,
                   Game1.GlobalToLocal(Game1.viewport,
                                       new Vector2(tileX.Value * 64,
                                                   tileY.Value * 64 + tilesHigh.Value * 64)),
                   new Rectangle(0, 48, 48, 48),
                   (overrideWaterColor.Value.Equals(Color.White) ? new Color(60, 126, 150) : overrideWaterColor.Value * alpha),
                   0f,
                   new Vector2(0f, 48f),
                   4f,
                   SpriteEffects.None,
                   (((float)tileY.Value + 0.5f) * 64f - 3f) / 10000f);
            for (int y = tileY.Value; y < tileY.Value + 3; y++)
            {
                for (int x = tileX.Value; x < tileX.Value + 2; x++)
                {
                    ...
                    if (num)
                    {
                        ...
                        b.Draw(Game1.mouseCursors,
                               Game1.GlobalToLocal(Game1.viewport, new Vector2(x * 64 + 32, (y + 1) * 64 - (int)Game1.currentLocation.waterPosition - 32)),
                               new Rectangle(Game1.currentLocation.waterAnimationIndex * 64,
                                             2064 + flipOffset,
                                             64,
                                             32 + (int)Game1.currentLocation.waterPosition - 5),
                               overrideWaterColor.Equals(Color.White) ? (Game1.currentLocation.waterColor.Value) : (overrideWaterColor.Value * 0.5f),
                               0f,
                               Vector2.Zero,
                               1f,
                               SpriteEffects.None,
                               (((float)tileY.Value + 0.5f) * 64f - 2f) / 10000f);
                    }
                    else
                    {
                        int flipOffset;
                        ...
                        b.Draw(Game1.mouseCursors,
                               Game1.GlobalToLocal(Game1.viewport,
                                                   new Vector2(x * 64 + 32,
                                                               y * 64 + 32 - (int)((!topY) ? Game1.currentLocation.waterPosition : 0f))),
                               new Rectangle(Game1.currentLocation.waterAnimationIndex * 64,
                                             2064 + flipOffset + (topY ? ((int)Game1.currentLocation.waterPosition) : 0),
                                             64,
                                             64 + (topY ? ((int)(0f - Game1.currentLocation.waterPosition)) : 0)),
                               (overrideWaterColor.Value.Equals(Color.White) ? Game1.currentLocation.waterColor.Value : (overrideWaterColor.Value * 0.5f)),
                               0f,
                               Vector2.Zero,
                               1f,
                               SpriteEffects.None,
            ...
            if (overrideWaterColor.Value.Equals(Color.White))
            {
                ...
                b.Draw(texture.Value,
                       Game1.GlobalToLocal(Game1.viewport,
                                           new Vector2(tileX.Value * 64 + 64,
                                                       tileY.Value * 64 + 44 + ((Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 2500.0 < 1250.0) ? 4 : 0))),
                       new Rectangle(16, 160, 48, 7),
                       color * alpha,
                       0f,
                       Vector2.Zero,
                       4f,
                       SpriteEffects.None,
                       (((float)tileY.Value + 0.5f) * 64f + 1f) / 10000f);
            }
            //main structure
            b.Draw(texture.Value,
                   Game1.GlobalToLocal(Game1.viewport, new Vector2(tileX.Value * 64, tileY.Value * 64 + tilesHigh.Value * 64)),
                   new Rectangle(0, 0, 48, 48),
                   color * alpha,
                   0f,
                   new Vector2(0f, 48f),
                   4f,
                   SpriteEffects.None,
                   ((float)tileY.Value + 0.5f) * 64f / 10000f);
            if (nettingStyle.Value < 3)
            {
                //netting styles, disabled for now
                //b.Draw(texture.Value,
                //       Game1.GlobalToLocal(Game1.viewport, new Vector2(tileX.Value * 64, tileY.Value * 64 + tilesHigh.Value * 64 - 128)),
                //       new Rectangle(80, nettingStyle.Value * 48, 80, 48),
                //       color * alpha,
                //       0f,
                //       new Vector2(0f, 80f),
                //       4f,
            ...
            if (sign.Value != null)
            {
                ...
                b.Draw(dataOrErrorItem.GetTexture(),
                       Game1.GlobalToLocal(Game1.viewport,
                                           new Vector2(tileX.Value * 64 + 8 - 20,
                                                       tileY.Value * 64 + tilesHigh.Value * 64 - 128 - 32 + 16)),
                       ...
                       4f,
                       SpriteEffects.None,
                       (((float)tileY.Value + 2.5f) * 64f + 2f) / 10000f); // previous tileY offset was 0.5f
                if (fishType.Value != null)
                {
                    ...
                    if (data != null)
                    {
                        ...
                        b.Draw(texture2D,
                               Game1.GlobalToLocal(Game1.viewport,
                                                   new Vector2(tileX.Value * 64 + 8 + 8 - 4 - 20,
                                                               tileY.Value * 64 + tilesHigh.Value * 64 - 128 - 8 + 4 + 16)),
                               sourceRect,
                               ...
                               3f,
                               SpriteEffects.None,
                               (((float)tileY.Value + 2.5f) * 64f + 3f) / 10000f);
                        b.Draw(texture2D,
                               Game1.GlobalToLocal(Game1.viewport,
                                                   new Vector2(tileX.Value * 64 + 8 + 8 - 1 - 20,
                                                               tileY.Value * 64 + tilesHigh.Value * 64 - 128 - 8 + 1 + 16)),
                               sourceRect,
                               color * alpha,
                               0f,
                               Vector2.Zero,
                               3f,
                               SpriteEffects.None,
                               (((float)tileY.Value + 2.5f) * 64f + 4f) / 10000f);
                        //number
                        Utility.drawTinyDigits(currentOccupants.Value,
                                               b,
                                               Game1.GlobalToLocal(Game1.viewport,
                                                                   new Vector2(tileX.Value * 64 + 32 + 8 - 20 + ((currentOccupants.Value < 10) ? 8 : 0),
                                                                               tileY.Value * 64 + tilesHigh.Value * 64 - 96 + 16)),
                                               3f,
                                               (((float)tileY.Value + 2.5f) * 64f + 5f) / 10000f,
            ...
            if (_fishObject != null && (_fishObject.QualifiedItemId == "(O)393" || _fishObject.QualifiedItemId == "(O)397"))
            {
                ...
                for (int k = 0; k < currentOccupants.Value; k++)
                {
                    ...
                    b.Draw(Game1.shadowTexture,
                           Game1.GlobalToLocal(Game1.viewport,
                                               new Vector2(tileX.Value * 64 + 64 + (int)(7 * coralResize),
                                                           tileY.Value * 64 + 64 + (int)(32 * coralResize)) + drawOffset),
                           ...
                           3f * coralResize,
                           SpriteEffects.None,
                           (((float)tileY.Value + 0.5f) * 64f - 2f) / 10000f - 1.1E-05f);
                    ...
                    b.Draw(texture2D2,
                           Game1.GlobalToLocal(Game1.viewport, new Vector2(tileX.Value * 64 + 64, tileY.Value * 64 + 64) + drawOffset),
                           fishSourceRect,
                           color * alpha * 0.75f,
                           0f,
                           Vector2.Zero,
                           3f * coralResize,
                           (drawI % 3 == 0) ? SpriteEffects.FlipHorizontally : SpriteEffects.None,
                           (((float)tileY.Value + 0.5f) * 64f - 2f) / 10000f - 1E-05f);
                }
            }
            else
            {
            ...
            if (HasUnresolvedNeeds())
            {
                ...
                b.Draw(Game1.mouseCursors,
                       Game1.GlobalToLocal(Game1.viewport, drawn_position),
            ...
            {
                b.Draw(texture.Value,
                       Game1.GlobalToLocal(Game1.viewport, new Vector2(tileX.Value * 64, tileY.Value * 64) + new Vector2(124f, 128f) * 4f),
                       new Rectangle(130, 96, 17, 16),
                       color * alpha,
                       0f,
                       Vector2.Zero,
                       4f,
            ...
            if (output.Value != null)
            {
                ...
                b.Draw(texture.Value,
                       Game1.GlobalToLocal(Game1.viewport, new Vector2(tileX.Value * 64, tileY.Value * 64) + new Vector2(124f, 128f)),
                       new Rectangle(0, 96, 17, 16),
                       color * alpha,
                       0f,
                       Vector2.Zero,
                       4f,
                ...
                b.Draw(Game1.mouseCursors,
                       Game1.GlobalToLocal(Game1.viewport, bubble_draw_position),
                ...
                b.Draw(texture2D3,
                       Game1.GlobalToLocal(Game1.viewport, bubble_draw_position + item_relative_to_bubble),
                       dataOrErrorItem3.GetSourceRect(),
                       Color.White * 0.75f,
                       0f,
                       new Vector2(8f, 8f),
                       4f,
                ...
                if (output.Value is ColoredObject)
                {
                    ...
                    b.Draw(texture2D3,
                           Game1.GlobalToLocal(Game1.viewport, bubble_draw_position + item_relative_to_bubble),
                           sourceRect3,
                           (output.Value as ColoredObject).color.Value * 0.75f,
                           0f,
                           new Vector2(8f, 8f),
                           4f,
                           SpriteEffects.None,
                           item_layer_depth + 1E-05f);
                }
            }
        }
    }
